...
Next, I'll refactor my procedural Tic-Tac-Toe game, using OOP principles.

Here is the final version of my procedural Tic-Tac-Toe game:

*File:* [[https://github.com/XiaoA/tealeaf-course1-week1/blob/master/tic_tac_toe_ai.rb]]
#+BEGIN_SRC ruby 
...
** First Step: Think about the implementation, using plain English
...
First, I'll draw the board...

*File:* [[oop_ttt/oop_ttt_v1.rb]]
#+BEGIN_SRC ruby :tangle oop_ttt/oop_ttt_v1.rb
  # oop_ttt/oop_ttt_v1.rb
...
And that worked! Next, I'll add in more of the 'Board' methods I set up before.
